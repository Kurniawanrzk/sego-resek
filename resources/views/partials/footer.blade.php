<footer style="background-color:#fcf5e1;margin-top:100px;padding-top:50px;" class=" shadow">
    ...
    <div class="d-flex justify-content-around">
        ...
        <div>
            <h4 class="">Contact Us In</h4>
            <div class="">
                <a style="text-decoration: none" href="https://www.instagram.com/segoresekjingkrak/"><p class="ms-4" style="color:#4e4a3f"><img src="assets/img/ig.png" width="20" alt=""> @segoresekjingkrak</p></a>
                <p class="ms-4"><img src="assets/img/Logo Telfon.png" width="20" alt=""> 0895-8111-07744</p>
            </div>
            <h4 class="">Order Our Food In</h4>
            <div ><img src="assets/img/logo-shopee.png" width="70" alt=""><img src="assets/img/gofood.png" width="80" alt=""> <img src="assets/img/grab.png" width="50" alt=""></div>
        </div>
    </div>

        <hr>
        <div class="text-center">
            <img src="assets/img/logo.png" width="130" alt="LOGO SEGO RESEK">
            <p>Copyright 2024 sego resek jingkrak, Inc - All Right Reserved.</p>
        </div>
    </div>
</footer>
